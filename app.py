...
st.markdown("""
    ...
    .mes-button {
        ...
        background-color: #E60012; /* 전우정밀 느낌의 레드 혹은 포인트 컬러 */
        border-radius: 5px;
...
with h_col2:
    ...
    # MES 실시간 현황판 연결 버튼
    st.markdown('<a href="http://mes.jwjm.com" target="_blank" class="mes-button">📊 실시간 가동 현황판 보기</a>', unsafe_allow_html=True)
